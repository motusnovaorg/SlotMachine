...
namespace UnityStandardAssets.CrossPlatformInput
{
    ...
    private Image m_Image;
		...
		void Update()
		{
			...
			if (UnityEngine.Input.touchCount >= m_Id + 1 && m_Id != -1)
			{
#if !UNITY_EDITOR
            ...
            pointerDelta.y *= Ysensitivity;
				...
				pointerDelta.x = UnityEngine.Input.mousePosition.x - m_PreviousMouse.x;
				pointerDelta.y = UnityEngine.Input.mousePosition.y - m_PreviousMouse.y;
				m_PreviousMouse = new Vector3(UnityEngine.Input.mousePosition.x, UnityEngine.Input.mousePosition.y, 0f);
#endif
