...
namespace ChartAndGraph
{
    ...
    public abstract class ScrollableAxisChart : AxisChart
    {
        ...
        public bool MouseToClient(out double x,out double y)
        {
            ...
            if (mCaster == null)
                return false;
            RectTransformUtility.ScreenPointToLocalPointInRectangle(transform as RectTransform, UnityEngine.Input.mousePosition, mCaster.eventCamera, out mousePos);
            ...
            mousePos.x += fit.x;
            mousePos.y += fit.y;
            bool mouseIn = RectTransformUtility.RectangleContainsScreenPoint(transform as RectTransform, UnityEngine.Input.mousePosition);
       ...
       //     Debug.Log("try get " + val + " count is " + dic.Count);
        ...
        private void HandleMouseDrag()
        {
            ...
            bool mouseIn = RectTransformUtility.RectangleContainsScreenPoint(transform as RectTransform, UnityEngine.Input.mousePosition,Camera.main);
            if (UnityEngine.Input.GetMouseButton(0) && mouseIn)
            {
